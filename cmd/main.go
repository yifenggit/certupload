...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "999265f9.weyundong.com",
	...
	// Setup CertUpload controller
	if err = (&controller.CertUploadReconciler{
		Client:       mgr.GetClient(),
		Scheme:       mgr.GetScheme(),
		Recorder:     mgr.GetEventRecorderFor("certupload-controller"),
		AliyunClient: nil,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "CertUpload")
		os.Exit(1)
	}
